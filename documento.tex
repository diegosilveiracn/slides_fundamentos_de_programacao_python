...
\title[Fundamentos de Programação com Python]{Fundamentos de Programação com Python}
...
\begin{itemize}
	\item Em Python existe o comando para instrução de saída: \structure{print}.
\end{itemize}\vfill
...
\begin{itemize}
	\item Python possui a estrutura de seleção: \structure{if}
\end{itemize}
...
\begin{block}{Definição}
É uma subrotina de programa, capaz de executar uma tarefa definida pelo programador.
\end{block} \vfill
...
\begin{frame}[fragile]
	\frametitle{Parâmetro}
	
	\begin{block}{Definição}
		É o valor que deve ser passado para uma função durando sua utilização.
	\end{block} \vfill
...
\begin{frame}[fragile]
	...
	\begin{block}{Definição}
		É o resultado de alguma operação realizado pela função.
	\end{block}\vfill
...
\begin{block}{Definição}
É o recurso que permite a uma função refere-se a si mesma durante a própria definição.
\end{block} \vfill
